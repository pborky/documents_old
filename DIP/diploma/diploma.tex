...
%<------------------------------ headers ------------------------------------>
\newcommand{\Subject}{Diploma Thesis}
...
(vedouc\'{i}mu pr\'{a}ce, konzultantovi, tomu kdo p\r{u}j\v{c}il software, literaturu, %%
poskytl data apod.).}
...
\end{description}
\cleardoublepage{}\thispagestyle{empty}~{\small \addcontentsline{toc}{chapter}{Assignment of the Work} }{\small \par}
