...
\name{Chandola et al.} \cite{chandola2009anomaly} addressed anomaly detection in general and also identified various approaches and application domains.
...
\name{X. He, et al.} \cite{he2004spectral} explored an spectral analysis approach using fourier transform on features obtained from packet traces. 
...
%
The work of \name{Chen} and \name{Hwang} \cite{chen2007tcp,chen2007spectral} used similar approach to analyze spectral 
...
\emph{CAIDA Trace Project} \cite{caidaoc48trace,caida2010trace,caida2011trace}...
\name{DARPA Intrusion Detection Data Sets (IDEVAL)} are five weeks of packet trace data generated at \emph{MIT Lincoln Labs} for
...
%
\name{McHugh} \cite{mchugh2000testing} depicted an issues associated with design and execution of the IDEVAL datasets..
...
%
\name{Mahoney} and \name{Chan} \cite{mahoney2003analysis}
